meta["class"] = "Helper";
meta["public"] = [
    "connect", "command", "make", "fire", "showMember", "hideMember", "generate", "of"
];
...
o.init = function(options) {
    ...
    o.instanceOf = options.instanceOf;
...
o.of = function(className, instance) {
 
    return o.instanceOf(o.domainName, className, instance);
